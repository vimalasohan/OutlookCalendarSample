...
class CalendarViewController: UITableViewController {
    ...
    private var availabilities: [MSGraphScheduleItem]?
    ...
    override func viewDidLoad() {
        ...
        GraphManager.instance.getAvailabilty { (availabiltiy: [MSGraphScheduleItem]?, error: Error?) in
                        DispatchQueue.main.async {
                            self.spinner.stop()
            
                            guard let events = availabiltiy, error == nil else {
                                // Show the error
                            ...
                            self.availabilities = events
                        }

        }
//        GraphManager.instance.createEvent { (_) in
//
//        }
